"""
Django settings for house_wbs project.
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "wbs.context_processors.build_timestamp",
            ],
        },
    },
]
...
WSGI_APPLICATION = "house_wbs.wsgi.application"
...
if DEBUG:
    ...
    # Query logging for performance profiling
    LOGGING = {
        "version": 1,

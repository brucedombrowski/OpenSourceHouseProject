...
- After setting the macro path or symlink, the macros (e.g., `Joist_Module_2x12_16x16.FCMacro`, `Joist_Module_2x12_16x8.FCMacro`) should appear in the Macro dialog without manual import.

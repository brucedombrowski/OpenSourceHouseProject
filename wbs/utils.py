...
def calculate_task_duration(start_date, end_date, inclusive: bool = True) -> Decimal:
    """Calculate duration in days between two dates.

    Default is inclusive (e.g., Jan 1 to Jan 1 = 1 day) to align with rollup semantics.
    """
